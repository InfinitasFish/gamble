...
from constants import TS_SEQUENCE_LEN, CACHE_FPATH, CANDLES_UNI_FEATURE
...
def get_candles_uni_xy_pipe(from_utc: str, to_utc: str, instrument_id: str, normalize: bool=False,
                            interval: str="CANDLE_INTERVAL_DAY", sequence_len: int=TS_SEQUENCE_LEN, cache_fpath: str=CACHE_FPATH, to_cache: bool=False) -> Tuple[np.ndarray, np.ndarray]:
